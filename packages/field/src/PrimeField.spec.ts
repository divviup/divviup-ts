...
describe("PrimeField;", () => {
      ...
      [3n, 11n, 101n].forEach((modulus) => {
        describe(`modulus ${modulus}n;`, () => {
          ...
          vTests.forEach(({ v1, v2, vr }) => {
            it(`should correctly add vectors ${strVector(v1)} and ${strVector(
              v2,
            )}`, () => {
              const fv1 = F.newVectorFrom(v1);
              const fv2 = F.newVectorFrom(v2);
          ...
          nTests.forEach(({ v1, n, vr }) => {
            it(`should correctly add vector ${strVector(
              v1,
            )} and number ${n}`, () => {
              const fv1 = F.newVectorFrom(v1);
              expect(F.addVectorElements(fv1, n).values).to.deep.equal(
                vr.map((n) => F.mod(n)),
              );
            });
          });
    ...
    describe("subVectorElements();", () => {
      ...
      [3n, 11n, 101n].forEach((modulus) => {
        describe(`modulus ${modulus}n;`, () => {
          ...
          vTests.forEach(({ v1, v2, vr }) => {
            it(`should correctly subtract vectors ${strVector(
              v1,
            )} and ${strVector(v2)}`, () => {
              const fv1 = F.newVectorFrom(v1);
              const fv2 = F.newVectorFrom(v2);
              expect(F.subVectorElements(fv1, fv2).values).to.deep.equal(
                vr.map((n) => F.mod(n)),
              );
            });
          });
          ...
          nTests.forEach(({ v1, n, vr }) => {
            it(`should correctly subtract number ${n} from vector ${strVector(
              v1,
            )}`, () => {
              const fv1 = F.newVectorFrom(v1);
              expect(F.subVectorElements(fv1, n).values).to.deep.equal(
                vr.map((n) => F.mod(n)),
              );
            });
          });
    ...
    describe("mulVectorElements();", () => {
      ...
      [3n, 11n, 101n].forEach((modulus) => {
        describe(`modulus ${modulus}n;`, () => {
          ...
          vTests.forEach(({ v1, v2, vr }) => {
            it(`should correctly multiply vectors ${strVector(
              v1,
            )} and ${strVector(v2)}`, () => {
              const fv1 = F.newVectorFrom(v1);
              const fv2 = F.newVectorFrom(v2);
              expect(F.mulVectorElements(fv1, fv2).values).to.deep.equal(
                vr.map((n) => F.mod(n)),
              );
            });
          });
          ...
          nTests.forEach(({ v1, n, vr }) => {
            it(`should correctly multiply vector ${strVector(
              v1,
            )} and number ${n}`, () => {
              const fv1 = F.newVectorFrom(v1);
              expect(F.mulVectorElements(fv1, n).values).to.deep.equal(
                vr.map((n) => F.mod(n)),
              );
            });
          });
    ...
    describe("divVectorElements();", () => {
      ...
      [3n, 11n, 101n].forEach((modulus) => {
        describe(`modulus ${modulus}n;`, () => {
          ...
          vTests.forEach(({ v1, v2, vr }) => {
            it(`should correctly divide vectors ${strVector(
              v1,
            )} and ${strVector(v2)}`, () => {
              const fv1 = F.newVectorFrom(v1);
              const fv2 = F.newVectorFrom(v2);
              expect(F.divVectorElements(fv1, fv2).values).to.deep.equal(
                vr[Number(modulus)].map((n) => F.mod(n)),
              );
            });
          });

          nTests.forEach(({ v1, n, vr }) => {
            it(`should correctly divide vector ${strVector(
              v1,
            )} by number ${n}`, () => {
              const fv1 = F.newVectorFrom(v1);
              expect(F.divVectorElements(fv1, n).values).to.deep.equal(
                vr[Number(modulus)].map((n) => F.mod(n)),
              );
            });
          });
    ...
    describe("expVectorElements();", () => {
      ...
      [3n, 11n, 101n].forEach((modulus) => {
        describe(`modulus ${modulus}n;`, () => {
          ...
          vTests.forEach(({ v1, v2, vr }) => {
            it(`should correctly raise vector ${strVector(
              v1,
            )} to a power ${strVector(v2)}`, () => {
              const fv1 = F.newVectorFrom(v1);
              const fv2 = F.newVectorFrom(v2);
              expect(F.expVectorElements(fv1, fv2).values).to.deep.equal(
                vr.map((n) => F.mod(n)),
              );
            });
          });
          ...
          nTests.forEach(({ v1, n, vr }) => {
            it(`should correctly raise vector ${strVector(
              ...
              const fv1 = F.newVectorFrom(v1);
              expect(F.expVectorElements(fv1, n).values).to.deep.equal(
                vr.map((n) => F.mod(n)),
              );
            });
          });
      ...
      [3n, 11n, 101n].forEach((modulus) => {
        describe(`modulus ${modulus}n;`, () => {
          ...
          tests.forEach(({ v1, v2, r }) => {
            it(`should correctly combine vectors ${strVector(
              v1,
            )} and ${strVector(v2)}`, () => {
              const fv1 = F.newVectorFrom(v1);
              const fv2 = F.newVectorFrom(v2);
  ...
  //   const normalize =
  //     (F: PrimeField): ((m: bigint[][]) => bigint[][]) =>
  //     (m: bigint[][]): bigint[][] =>
  //       m.map((n1) => n1.map((n2) => F.mod(n2)));
  ...
  //           it(`should correctly add matrices ${strMatrix(m1)} and ${strMatrix(
  //             m2
  //           )}`, () => {
  //             let fm1 = F.newMatrixFrom(m1);
  //             let fm2 = F.newMatrixFrom(m2);
  //             expect(F.addMatrixElements(fm1, fm2).values).to.deep.equal(
  //               normF(mr)
  //             );
  //           });
  //         });
  ...
  //           it(`should correctly add matrix ${strMatrix(
  //             m1
  //           )} and number ${n}`, () => {
  //             let fm1 = F.newMatrixFrom(m1);
  //             expect(F.addMatrixElements(fm1, n).values).to.deep.equal(
  //               normF(mr)
  //             );
  //           });
  //         });
  ...
  //         mTests.forEach(({ m1, m2, mr }) => {
  //           it(`should correctly subtract matrices ${strMatrix(
  //             m1
  //           )} and ${strMatrix(m2)}`, () => {
  //             let fm1 = F.newMatrixFrom(m1);
  //             let fm2 = F.newMatrixFrom(m2);
  //             expect(F.subMatrixElements(fm1, fm2).values).to.deep.equal(
  //               normF(mr)
  //             );
  //           });
  //         });
  ...
  //         nTests.forEach(({ m1, n, mr }) => {
  //           it(`should correctly subtract number ${n} from matrix ${strMatrix(
  //             m1
  //           )}`, () => {
  //             let fm1 = F.newMatrixFrom(m1);
  //             expect(F.subMatrixElements(fm1, n).values).to.deep.equal(
  //               normF(mr)
  //             );
  //           });
  //         });
  ...
  //         mTests.forEach(({ m1, m2, mr }) => {
  //           it(`should correctly multiply matrices ${strMatrix(
  //             m1
  //           )} and ${strMatrix(m2)}`, () => {
  //             let fm1 = F.newMatrixFrom(m1);
  //             let fm2 = F.newMatrixFrom(m2);
  //             expect(F.mulMatrixElements(fm1, fm2).values).to.deep.equal(
  //               normF(mr)
  //             );
  //           });
  //         });
  ...
  //         nTests.forEach(({ m1, n, mr }) => {
  //           it(`should correctly multiply matrix ${strMatrix(
  //             m1
  //           )} and number ${n}`, () => {
  //             let fm1 = F.newMatrixFrom(m1);
  //             expect(F.mulMatrixElements(fm1, n).values).to.deep.equal(
  //               normF(mr)
  //             );
  //           });
  //         });
  ...
  //             [0n, 2n, 0n],
  //             [1n, 0n, 0n],
  //           ], // * [[0n, 2n, 0n], [0n, 2n, 0n], [1n, 0n, 0n]]
  //           11: [
  //             [0n, 36n, 18n],
  //             [0n, 40n, 8n],
  //             [1n, 0n, 16n],
  //           ], // * [[1n, 9n, 6n], [3n, 8n, 4n], [1n, 0n, 4n]]
  //           101: [
  //             [0n, 324n, 153n],
  //             [0n, 145n, 68n],
  //             [1n, 0n, 136n],
  //           ], // * [[1n, 81n, 51n], [76n, 29n, 34n], [1n, 0n, 34n]]
  //         },
  //       },
  //     ];
  //     const nTests = [
  ...
  //         mTests.forEach(({ m1, m2, mr }) => {
  //           it(`should correctly divide matrices ${strMatrix(
  //             m1
  //           )} and ${strMatrix(m2)}`, () => {
  //             let fm1 = F.newMatrixFrom(m1);
  //             let fm2 = F.newMatrixFrom(m2);
  //             expect(F.divMatrixElements(fm1, fm2).values).to.deep.equal(
  //               normF((mr as any)[resultKey])
  //             );
  //           });
  //         });

  //         nTests.forEach(({ m1, n, mr }) => {
  //           it(`should correctly divide matrix ${strMatrix(
  //             m1
  //           )} by number ${n}`, () => {
  //             let fm1 = F.newMatrixFrom(m1);
  //             expect(F.divMatrixElements(fm1, n).values).to.deep.equal(
  //               normF((mr as any)[resultKey])
  //             );
  //           });
  //         });
  ...
  //         mTests.forEach(({ m1, m2, mr }) => {
  //           it(`should correctly raise matrix ${strMatrix(
  //             m1
  //           )} to a power ${strMatrix(m2)}`, () => {
  //             let fm1 = F.newMatrixFrom(m1);
  //             let fm2 = F.newMatrixFrom(m2);
  //             expect(F.expMatrixElements(fm1, fm2).values).to.deep.equal(
  //               normF(mr)
  //             );
  //           });
  //         });
  ...
  //           )} to a power ${n}`, () => {
  //             let fm1 = F.newMatrixFrom(m1);
  //             expect(F.expMatrixElements(fm1, n).values).to.deep.equal(
  //               normF(mr)
  //             );
  //           });
  //         });
  ...
  //           it(`should correctly multiple matrices ${strMatrix(
  //             m1
  //           )} and ${strMatrix(m2)}`, () => {
  //             let fm1 = F.newMatrixFrom(m1);
  //             let fm2 = F.newMatrixFrom(m2);
  ...
  //         tests.forEach(({ m, v, r }) => {
  //           it(`should correctly multiple matrix ${strMatrix(
  //             m
  //           )} and vector${strVector(v)}`, () => {
  //             let fm = F.newMatrixFrom(m);
  //             let fv = F.newVectorFrom(v);
  //             expect(F.mulMatrixByVector(fm, fv).values).to.deep.equal(
  //               r.map((n) => F.mod(n))
  //             );
  //           });
  //         });
  ...
  describe("Basic polynomial operations;", () => {
        ...
        describe(`modulus ${modulus}n;`, () => {
          ...
          tests.forEach(({ p1, p2, pr }) => {
            it("should correctly add two polynomials", () => {
              const fp1 = F.newVectorFrom(p1);
              const fp2 = F.newVectorFrom(p2);
              expect(F.addPolys(fp1, fp2).values).to.deep.equal(
                pr.map((n) => F.mod(n)),
              );
            });
          });
        ...
        describe(`modulus ${modulus}n;`, () => {
          ...
          tests.forEach(({ p1, p2, pr }) => {
            it("should correctly subtract two polynomials", () => {
              const fp1 = F.newVectorFrom(p1);
              const fp2 = F.newVectorFrom(p2);
              expect(F.subPolys(fp1, fp2).values).to.deep.equal(
                pr.map((n) => F.mod(n)),
              );
            });
          });
        ...
        describe(`modulus ${modulus}n;`, () => {
          ...
          tests.forEach(({ p1, p2, pr }) => {
            it("should correctly multiply two polynomials", () => {
              const fp1 = F.newVectorFrom(p1);
              const fp2 = F.newVectorFrom(p2);
              expect(F.mulPolys(fp1, fp2).values).to.deep.equal(
                pr.map((n) => F.mod(n)),
              );
            });
          });
        ...
        describe(`modulus ${modulus}n;`, () => {
          ...
          tests.forEach(({ p1, p2, pr }) => {
            it("should correctly divide two polynomials", () => {
              const fp1 = F.newVectorFrom(p1);
              const fp2 = F.newVectorFrom(p2);
              expect(F.divPolys(fp1, fp2).values).to.deep.equal(
                pr.map((n) => F.mod(n)),
              );
            });
          });
      ...
      [7n, 11n, 101n].forEach((modulus) => {
        describe(`modulus ${modulus}n;`, () => {
          ...
          it(`should return correctly polynom`, () => {
            const fxs = F.newVectorFrom(xs);
            const fys = F.newVectorFrom(ys);
            expect(F.interpolate(fxs, fys).values).to.deep.equal(
              poly.map((n) => F.mod(n)),
            );
          });
        });
    ...
    describe("interpolateRoots();", () => {
      ...
      [
        ...
        describe(`for polynom ${JSON.stringify(poly).replace(
          /"/g,
          "",
        )};`, () => {
          beforeEach(() => {
          ...
          it(`should return correctly polynom by interpolateRoots()`, () => {
            expect(F.interpolateRoots(xs, ys).values).to.deep.equal(
              poly.map((n) => F.mod(n)),
            );
          });

          it(`should return correctly polynom by interpolate()`, () => {
            expect(F.interpolate(xs, ys).values).to.deep.equal(
              poly.map((n) => F.mod(n)),
            );
          });
